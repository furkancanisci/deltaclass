                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="exam_analysis.php?id=1" class="btn btn-sm btn-outline-primary">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="exam_analysis.php?id=2" class="btn btn-sm btn-outline-primary">
                                        <i class="fas fa-chart-bar me-1"></i>Analiz
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <a href="exam_analysis.php?id=3" class="btn btn-sm btn-outline-primary">
                                        <i class="fas fa-chart-bar me-1"></i>Analiz
                                    </a>
                                </td>
                            </tr>
