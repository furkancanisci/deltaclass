...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="page-header d-flex justify-content-between align-items-center">
                <div>
                    <h1>Ahmet Yılmaz - TYT Deneme Sınavı #2</h1>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0"><i class="fas fa-comment me-2"></i>Yorum ve Öneriler</h5>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        <label class="form-label">Yorumunuz</label>
                        <textarea class="form-control" rows="4" placeholder="Öğrenciye özel yorum ve önerilerinizi buraya yazabilirsiniz..."></textarea>
                    </div>
                    <button class="btn btn-primary w-100">Yorumu Kaydet</button>
                </div>
            </div>
        </div>
    </div>
