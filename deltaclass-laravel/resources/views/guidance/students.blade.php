            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('guidance.students.show', 1) }}" class="btn btn-sm btn-outline-primary">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('guidance.students.show', 2) }}" class="btn btn-sm btn-outline-primary">
                                <i class="fas fa-user me-1"></i>Profil
                            </a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('guidance.students.show', 3) }}" class="btn btn-sm btn-outline-primary">
                                <i class="fas fa-user me-1"></i>Profil
                            </a>
                        </td>
                    </tr>
